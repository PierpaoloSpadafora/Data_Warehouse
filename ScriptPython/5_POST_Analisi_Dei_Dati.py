...
TEST_CSV_FILE = 'TEST_READY_OSD_plus_GDP.csv'
...
def move_files():
    """Sposta i file CSV nella directory superiore"""
    files_to_move = [CSV_FILE, TEST_CSV_FILE]
...
def main():
    ...
    try:
        ...
        # Crea la heatmap solo se ci sono dati
        if not qdf.empty:
    ...
    # Sposta i file alla fine dell'elaborazione
    move_files()
